...
def lik_opt(x, grad):
	...
	if args.data_in_area == 1:
		...
		dis_vec = np.array(x[opt_ind_dis]).reshape(n_Q_times,nareas)
	...
	if args.data_in_area == 1:
		...
		ext_vec = np.array(x[opt_ind_ext]).reshape(n_Q_times,nareas)	
	if args.TdE:			
...
if args.A == 3:
	...
	if args.data_in_area == 1:
		...
		ext_rate_vec = np.array(x[opt_ind_ext]).reshape(n_Q_times,nareas)
