...
f="/Users/danielesilvestro/Software/PyRate_github/experimental_code/test_q_8.52_1_epsilon_0.5_fZero_0.1_thr_11.log_estQslope1.log"
f="/Users/danielesilvestro/Software/PyRate_github/experimental_code/test_q_8.52_1_epsilon_0.5_fZero_0.1_thr_11_incr_q_estQslope1.log"
...
tbl = tbl[indxWFOSS,]
plot( tbl$root_true,tbl$root_est, xlim = c(0,200), ylim = c(0,200),pch = 19,col=alpha("black",0.2),type="p")
...
segments(x0 =tbl$root_true, x1=tbl$root_true, y0=tbl$root_mth, y1=tbl$root_Mth,lty=1,col=alpha("red",0.2))

hist(tbl$root_M2-tbl$root_m2)
...
plot( (tbl$root_obs-tbl$root_true), tbl$delta_lik)
