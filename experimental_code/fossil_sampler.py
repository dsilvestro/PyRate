...
##  OH: REPLACE THIS BY A FUNCTION TO READ THE TS/TE TABLE GENERATED BY SIMULATIONS
TS=np.array([10,5.,12])
TE=np.array([3.,1.,2])

##  REPLACE BY SOMETHING MEANINGFUL (E.G. SIMULATION NUMBER OR SIMULATION SETTINGS)
output = "sim"
