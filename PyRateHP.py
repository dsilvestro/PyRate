...
########################## LIKELIHOODS ##################################
def get_hyper_priorBD(timesL,timesM,L,M,T,s):	
	if tot_extant==-1:
...
if args.N>-1: tot_extant=args.N
	...
	print "Number of extant species (-N) not specified. Using Gamma/Cauchy priors on the birth-death rates.\n"
	tot_extant = -1
