...
You can use different time-series for speciation and extinction by providing the paths to two text files. These should have the same column names though. For instance, the emergance of humans could influence extinction rates but not on speciation rates.
