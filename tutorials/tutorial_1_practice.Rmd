...
HPP is the simplest model. It assumes preservation rate (q) is constant throughout all of time: a single parameter. All lineages have the same rate. **In Terminal, feed your PyRate input file into PyRate, and run the HPP model using the command -`mHPP`:**
